"""Training entrypoints for e-commerce support model."""
...
from .data import EcommerceDatasetPipeline, SupervisedDataCollator
...
def run_training(config: AppConfig) -> dict[str, Any]:
    ...
    pipeline = EcommerceDatasetPipeline(config)
